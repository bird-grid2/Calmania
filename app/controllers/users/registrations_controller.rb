...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def account_update_params
    add_list = [:nickname, :password, :password_confirmation, :height, :ideal_protain_rate, :ideal_fat_rate, :ideal_carbohydrate_rate, :target_cal, { clock_work_event_attributes: [:id, :period_id, :send_time] }]
