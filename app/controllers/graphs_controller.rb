class GraphsController < ApplicationController
  ...
  def reset_cache
    ...
    return unless File.exist?(helper.asset_url("test_#{@user.id}_1.png"))

    os.remove(helper.asset_url("test_#{@user.id}_1.png"))
    os.remove(helper.asset_url("test_#{@user.id}_2.png"))
    os.remove(helper.asset_url("test_#{@user.id}_3.png"))
    os.remove(helper.asset_url("test_#{@user.id}_4.png"))
  end
end
