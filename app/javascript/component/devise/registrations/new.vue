    ...
    <form class="new_user" id="new_user" action="/users" accept-charset="UTF-8" method="post">
      <div class="left_box">
        <div class="field">
          ...
          <input autofocus="autofocus" placeholder="ニックネームを入力してください" required="required" type="text" name="user[nickname]" id="user_nickname">
        </div>
        <div class="field">
          <label class="new" for="user_email_メールアドレス_必須">メールアドレス (必須)</label>
          <input placeholder="メールアドレスを入力してください" required="required" type="email" value="" name="user[email]" id="user_email">
        </div>
        <div class="field">
          <label class="new" for="user_height_身長cm_任意">身長[cm] (任意)</label>
          <input placeholder="身長を入力してください" step="0.1" type="number" name="user[height]" id="user_height">
        </div>
      </div>
      ...
      <div class='right_box '>
        <div class='field'>
          <div class='field-box'>
              ...
              <em>"#{@minimum_password_length}字以上入力"</em>
          </div>
          <input placeholder="パスワード入力" type="password" name="user[password]" id="user_password">
        </div>
        <div class='field'>
        ...
        <div class='actions'>
          <input type="submit" name="commit" value="新規作成" data-disable-with="新規作成">
